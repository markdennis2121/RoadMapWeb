    ...
    <main className="flex min-h-screen items-center justify-center bg-[#f5f7fb] px-5 py-10 text-slate-800">
      <section className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-xl">
        <div className="mb-8 text-center">
          <img src="/logo.png" alt="" className="mx-auto mb-4 h-14 w-14 rounded-2xl shadow-md" />
          <h1 className="font-['Space_Grotesk'] text-3xl font-bold text-slate-900">Roadmap Tracker</h1>
          <p className="mt-2 text-sm text-slate-500">Your personal web development roadmap.</p>
        </div>
        ...
        <div className="mb-6 grid grid-cols-2 rounded-xl bg-slate-100 p-1">
          ...
          <button
            ...
            className={`rounded-lg py-2 text-sm font-bold transition ${
              mode === 'signup' ? 'bg-white text-indigo-600 shadow-sm' : 'text-slate-500 hover:text-slate-800'
            }`}
          >
            Sign up
          </button>
        ...
        <div className="mb-5 grid grid-cols-3 gap-2">
          <button
            ...
            disabled={busy}
            className="rounded-xl border border-slate-200 bg-white px-2 py-2.5 text-xs font-bold text-slate-700 hover:bg-slate-50 hover:border-indigo-300 disabled:opacity-60 shadow-sm transition"
          >
            Google
          </button>
          <button
